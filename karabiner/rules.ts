...
const rules: KarabinerRules[] = [
  ...
  ...createHyperSubLayers({
    q: {
      to_if_alone: [{ shell_command: "aerospace focus-monitor --wrap-around left" }],
    },
    o: {
      w: app("WezTerm"),
      a: app("Siri"),
      ...
      r: app("Postman"),
      s: { to: [{ shell_command: "aerospace workspace 5" }] },
      p: {
        to: [
          {
  ...
  ...createHyperSubLayers({
    ...
    w: {
      to_if_alone: [
        {
          shell_command: "aerospace move-node-to-monitor next --wrap-around --focus-follows-window",
        },
      ],
      to_if_held_down: [
        {
          shell_command: "aerospace move-workspace-to-monitor next --wrap-around",
        },
      ],
    },
    ...
    close_bracket: { to_if_alone: [{ shell_command: "aerospace workspace next" }] },
    open_bracket: { to_if_alone: [{ shell_command: "aerospace workspace prev" }] },
  }),
  ...mainWorkflow,
  ...MOUSE_LAYER,
];
